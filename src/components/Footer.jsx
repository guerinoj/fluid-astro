      ...
      <div className="pt-10  lg:pt-20 lg:pb-12 bg-white radius-for-skewed ">
        <div className="container mx-auto px-4 w-4/5 md:w-11/12 lg:w-10/12 xl:w-4/5 2xl:w-2/3">
          <div className="text-center text-primary-900">
            <h2 className="mx-auto my-10 text-2xl font-black text-center lg:w-2/3 xl:w-1/2 sm:text-5xl ">Prêt à <strong>booster</strong> votre activité ?</h2>
          ...
          <div className="flex justify-center pt-16 space-x-10">
            
              <a href='https://www.linkedin.com/in/jonathan-guerino-14b34951' target="_blank" className="text-primary-500 hover:text-primary-600">
              ...
              <a href='mailto:support@fluid-crm.fr' target="_blank" className="text-primary-500 hover:text-primary-600">
