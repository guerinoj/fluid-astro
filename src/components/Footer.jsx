const socials = [
  { link: 'https://www.linkedin.com/in/jonathan-guerino-14b34951', label: 'LinkedIn' },
      ...
      <div className="pt-10  lg:pt-20 lg:pb-12 bg-white radius-for-skewed ">
        <div className="container mx-auto px-4 w-4/5 md:w-11/12 lg:w-10/12 xl:w-4/5 2xl:w-2/3">
          <div className="text-center text-primary-900">
            <h2 class="mx-auto my-5 text-2xl font-black text-center lg:w-2/3 xl:w-1/2 sm:text-5xl ">Prêt à <strong>booster</strong> votre activité ?</h2>
            <p>Testez dès maintenant Fluid CRM pendant 14 jours et découvrez comment simplifier votre gestion de clients.</p>
          </div>
          ...
          <div class="flex justify-center mt-8 space-x-10">
            {socials.map(({ link, label }) => (
              <a href={link} target="_blank" class="text-primary-500 hover:text-primary-600">
